...
function check(textbox){
    if(document.getElementById("id").value=="" || "is-invalid"){
        id.focus();
        return;
    }
    if(document.getElementById("pwd").value=="" || "is-invalid"){
              pwd.focus();
              return;
    }
    if(document.getElementById("pwd2").value=="" || "is-invalid"){
              pwd2.focus();
              return;
          }
    if(document.getElementById("name").value=="" || "is-invalid"){
              name.focus();
              return;
          }
    if(document.getElementById("phone").value=="" || "is-invalid"){
              phone.focus();
              return;
          }
    if(document.getElementById("email").value=="" || "is-invalid"){
              email.focus();
              return;
          }
    }
...
<div class="container">
	...
	<form class="animate__animated animate__bounceInDown" action="${pageContext.request.contextPath}/users/signup.do" method="post" id="myForm">
		...
		<button class="btn btn-primary" type="submit" onclick="check()" >가입</button>
	</form>
</div>
