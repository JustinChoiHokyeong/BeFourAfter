...
<body>
	...
	<div class="bg-light">
		<div class="container">
			...
			<ul>
				<li><a
					href="${pageContext.request.contextPath }/reserve/leave_insertform.do">출국서비스
						예약하기</a></li>
				<li><a
					href="${pageContext.request.contextPath }/reserve/ent_insertform.do">입국서비스
						예약하기</a></li>
			</ul>
		</div>
				...
				<tbody>
					<c:forEach var="tmp" items="${list }">
						<tr>
							...
							<td>${tmp.over }개</td>
							<td><a
								href="${pageContext.request.contextPath }/reserve/updateform.do?num=${ tmp.num}">일정
									수정</a></td>
							<td><a
								href="${pageContext.request.contextPath }/reserve/delete.do?num=${ tmp.num}"
								onclick="return confirm('예약을 취소하시겠습니까?')">삭제</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div>
			<a href="${pageContext.request.contextPath }"><button class="btn">홈으로</button></a>
		</div>
	</div>
	<!-- /본문 -->
