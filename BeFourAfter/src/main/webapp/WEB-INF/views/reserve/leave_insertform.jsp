...
<body style="background-color: white;">
   ...
   <div>
    ...
    padding-left: 80px;">출국
               서비스</h1>
            <div class="container" style="width: 600px; height: 600px; padding-left:50px;">
               ...
               <form action="leave_insert.do" method="post" id="leave_insertform"
                  ...
                  <div class="input-group">
                     <span class="input-group-text" for="name" style="background:bisque;border: 1px solid black;">예약자 이름</span> <input
