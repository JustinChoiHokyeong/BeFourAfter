...
<body style="background-color: white;">
   ...
   <div>
      ...
      <!--/바로가기-->
      <!-- 본문 -->
      <div class="container" style="padding: 0 50px 50px 50px; border-radius: 20px; border-style: outset; box-shadow: 5px 5px 5px 5px grey; width: 600px; height: 700px; margin-bottom: 50px;">
            ...
            <div class="container" style="width: 600px; height: 600px">
               ...
               <form action="leave_insert.do" method="post" id="leave_insertform"
                  style="text-align: -webkit-center; width: 475px;">
                  ...
                  <div class="input-group">
                     <label class="input-group-text" for="basic" style="width: 120px;">기본
                        ...
                        style="width: 250px"> <small style="font-size: x-small;">(캐리어28인치
                  ...
                  <div class="input-group">
                     <label class="input-group-text" for="over" style="width: 120px;">25kg
                        ...
                        class="input-group-text" for="over" style="width: 250px">
